...
python3 -m align.uts_template_qa

echo "------------------------------"
echo "[2/6] MTS-Shape Template"
python3 -m align.mts_shape_template_qa

echo "------------------------------"
echo "[3/6] MTS-Local Template"
python3 -m align.mts_local_template_qa

echo "------------------------------"
echo "[4/6] UTS LLM"
python3 -m align.uts_llm_qa

echo "------------------------------"
echo "[5/6] MTS-Shape LLM"
python3 -m align.mts_shape_llm_qa

echo "------------------------------"
echo "[6/6] MTS-Local LLM"
python3 -m align.mts_local_llm_qa
